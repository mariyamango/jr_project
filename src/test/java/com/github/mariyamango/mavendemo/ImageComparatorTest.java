package com.github.mariyamango.mavendemo;
...
class ImageComparatorTest {
    ...
    public void shouldConfirmImagesNotTheSame() {
        ...
        //when
        boolean theSameImage = comparator.isTheSameImage(image1, image2);

        //then
        Assertions.assertFalse(theSameImage);
    }
    ...
    public void shouldConfirmImagesTheSame() {
        ...
        //when
        boolean theSameImages = comparator.isTheSameImage(image1, image1);
